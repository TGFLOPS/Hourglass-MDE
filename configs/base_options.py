...
class BaseOptions():
    ...
    def initialize(self):
        ...
        parser.add_argument('--backbone',   type=str, default='swin_large_v2')
        parser.add_argument('--pretrained',    type=str, default='weights/swin_v2_large_simmim.pth')
        parser.add_argument('--window_size', default=[30,30,30,15])
        parser.add_argument('--pretrain_window_size', default=[12,12,12,6])
        parser.add_argument('--use_shift', default=[1,1,0,0])
        parser.add_argument('--depths', default=[2,2,18,2])
        ...
        parser.add_argument('--shift_window_test', action='store_true', default=True)     
        parser.add_argument('--shift_size',  type=int, default=2)
        parser.add_argument('--flip_test', action='store_true', default=True)       

...
class nyudepthv2(BaseDataset):
    def __init__(self, data_path, filenames_path='./dataset/filenames/',
        ...
        # self.data_path = os.path.join(data_path, 'sync')
        ...
        # for i in self.filenames_list:
        #     img_path = self.data_path + i.split(' ')[0]
        #     gt_path = self.data_path + i.split(' ')[1]
        ...
        #         self.depth_path_list.append(gt_path)
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            print("Error : {}, depth_path : {}".format(a, gt_path))
